            ...
            <div className="loginpage">
               <form  onSubmit={this.handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type='text' name="empName" value={this.state.empName} onChange={this.handleChange} placeholder="Enter Employee Name" required/>
                    </div>
                    <div>
                        <label>Employee Address:</label>
                        <input type='text' name="empAddress" value={this.state.empAddress} onChange={this.handleChange} placeholder="Enter Employee Address" required/>
                    </div>
                    <div>
